        ...
        <div
            ...
            style={{
                backgroundImage: `linear-gradient(180deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.9) 100%), url(${"https://image.tmdb.org/t/p/original/" + info.detail.backdrop_path ||
                    randomMovie.profile_path
                    })`,
            }}
        >
            <div className="absolute inset-0 bg-black/20 backdrop-blur-xs"></div>
            <div className="flex items-center md:justify-center h-full w-full relative z-30 flex-wrap">
                ...
                <div className="h-full md:w-1/2 w-full pt-5 pl-10 pr-5 md:p-10">
                    <h1 className="text-3xl font-medium">{info.detail.title || info.detail.original_title}</h1>
                    <h3 className="text-2xl opacity-70 font-light my-2">{info.detail.release_date.slice(0, 4)}</h3>
